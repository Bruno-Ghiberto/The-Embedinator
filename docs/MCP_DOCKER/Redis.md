...
Attribute|Details|
|-|-|
**Dockerfile**|https://github.com/redis/mcp-redis/blob/05a581bc87827d375b1215c5c4495393181ce1a8/Dockerfile
**Commit**|`05a581bc87827d375b1215c5c4495393181ce1a8`
...
Hybrid search pre-filters documents by metadata before ranking by vector similarity â€”
the standard pattern for production RAG and semantic search pipelines.

Filter expression examples:
    "*"                              â†’ no filter, pure vector search (same as vector_search_hash)
    "@category:{news}"              â†’ tag filter
    "@year:[2020 2024]"             â†’ numeric range
    "@lang:{en} @year:[2022 +inf]"  â†’ combined tag + range
    "@title:redis"                  â†’ full-text match on a text field
...
âš ï¸  WARNING: With very large datasets (millions of keys), this may consume significant memory.
...
âš ï¸  IMPORTANT: This returns PARTIAL results from one iteration. Use scan_all_keys()
